...
public class FileLockDemo {
    ...
    private static void getFileLock() throws IOException {
        // 创建FileChannel
        String path = PROJECT_PATH + "/netty2-nio-demo/nio5-flielock-demo/src/main/java/top/sharehome/filelock/file/1.txt";
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 接下来进行读操作
        FileReader fileReader = new FileReader(PROJECT_PATH + "/netty2-nio-demo/nio5-flielock-demo/src/main/java/top/sharehome/filelock/file/1.txt");

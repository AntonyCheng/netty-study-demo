...
public class Demo02FileChannel {
    ...
    public static void createFileChannel() throws FileNotFoundException {
        ...
        String path = PROJECT_PATH + "/netty2-nio-demo/nio1-channel/src/main/java/top/sharehome/channel/file/1.txt";
    ...
    public static void copy() throws IOException {
        ...
        String src = PROJECT_PATH + "/netty2-nio-demo/nio1-channel/src/main/java/top/sharehome/channel/file/1.txt";
        String dest = PROJECT_PATH + "/netty2-nio-demo/nio1-channel/src/main/java/top/sharehome/channel/file/1_tmp.txt";
    ...
    private static void transfer() throws IOException {
        // 先创建两个通道
        String src = PROJECT_PATH + "/netty2-nio-demo/nio1-channel/src/main/java/top/sharehome/channel/file/2.txt";
        String dest = PROJECT_PATH + "/netty2-nio-demo/nio1-channel/src/main/java/top/sharehome/channel/file/2_tmp.txt";
        FileInputStream srcStream = new FileInputStream(src);
        FileChannel srcChannel = srcStream.getChannel();
        FileOutputStream destStream = new FileOutputStream(dest);
        FileChannel destChannel = destStream.getChannel();
    ...
    private static void otherApis() throws IOException {
        ...
        String path1 = PROJECT_PATH + "/netty2-nio-demo/nio1-channel/src/main/java/top/sharehome/channel/file/3.txt";
        ...
        String path2 = PROJECT_PATH + "/netty2-nio-demo/nio1-channel/src/main/java/top/sharehome/channel/file/4.txt";
        ...
        String path3 = PROJECT_PATH + "/netty2-nio-demo/nio1-channel/src/main/java/top/sharehome/channel/file/5.txt";
